...
<?php $this->widget('zii.widgets.CMenu',array(
	...
	'items'=>array(
		array('label'=>'文章管理', 'url'=>array('#'),'items'=>array(
			array('label'=>'创建文章', 'url'=>array('/articles/create'), 'linkOptions'=>array('target'=>'navTab','rel'=>'art_create')),
			array('label'=>'管理文章', 'url'=>array('/articles/index'), 'linkOptions'=>array('target'=>'navTab','rel'=>'art_manager')),
		)),
